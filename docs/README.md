# Sniparr Documentation

This is the documentation site for [Sniparr](https://github.com/plexguide/Huntarr.io), served via GitHub Pages.
...
├── movie-hunt/
│   ├── index.html              # Movie Snipe overview
│   ├── media-collection.html
│   ├── indexers-clients.html
│   └── profiles.html
├── nzb-sniparr/
│   └── index.html              # NZB Sniparr overview
├── requestarr/
