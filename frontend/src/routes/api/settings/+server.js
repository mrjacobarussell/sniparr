...
import { invalidateCache } from '$lib/config'; // Assuming config.js handles sniparr.json read/write

// Use environment variables with fallbacks for configuration paths
const CONFIG_DIR = process.env.SNIPARR_CONFIG_DIR || process.cwd();
const CONFIG_FILE = path.join(CONFIG_DIR, 'sniparr.json'); // Path to the main config file
