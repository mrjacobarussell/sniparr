(function() {
        ...
        container.innerHTML = saveButtonTopHtml + `
            <div class="settings-group">
                ...
                <div class="setting-item">
                    <label for="show_trending"><a href="https://plexguide.github.io/Sniparr.io/settings/settings.html#show-trending" class="info-icon" title="Learn more about showing trending content on home page" target="_blank" rel="noopener"><i class="fas fa-info-circle"></i></a>Show Trending:</label>
                ...
                <div class="setting-item">
                    <label for="timezone"><a href="https://plexguide.github.io/Sniparr.io/settings/settings.html#timezone" class="info-icon" title="Set your timezone for accurate time display" target="_blank" rel="noopener"><i class="fas fa-info-circle"></i></a>Timezone:</label>
            ...
            <div class="settings-group">
                <h3>Security</h3>
                <div class="setting-item">
                    <label for="auth_mode"><a href="https://plexguide.github.io/Sniparr.io/settings/settings.html#authentication-mode" class="info-icon" title="Learn more about authentication modes" target="_blank" rel="noopener"><i class="fas fa-info-circle"></i></a>Authentication Mode:</label>
            ...
            <div class="settings-group">
                ...
                <div class="setting-item">
                    ...
                    <input type="text" id="base_url" value="${settings.base_url || ""}" placeholder="/sniparr">
                    <p class="setting-help" style="margin-left: -3ch !important;">Base URL path for reverse proxy. Requires restart.</p>
                </div>
                <div class="setting-item">
                    <label for="dev_key">Sniparr Dev Key:${(settings.dev_mode === true) ? ' <i class="fas fa-check-circle" style="color: #22c55e; margin-left: 5px;" title="Dev Mode Active"></i>' : ''}</label>
    ...
    window.SettingsForms.setupSettingsManualSave = function(container, originalSettings = {}) {
        ...
        newSaveButton.addEventListener("click", () => {
            ...
            const support = document.getElementById("display_sniparr_support");
            if (support) settings.display_sniparr_support = support.checked;
