(function() {
    ...
    // Sniparr is always dark — apply class for any legacy selectors
    ...
    localStorage.setItem('sniparr-logo-url', LOGO_URL);
    
    // Create a global function to apply the logo to all logo elements
    window.applyLogoToAllElements = function() {
        const logoUrl = localStorage.getItem('sniparr-logo-url') || LOGO_URL;
