...
def arr_request(api_url: str, api_key: str, api_timeout: int, endpoint: str, method: str = "GET", data: Dict = None, count_api: bool = True) -> Any:
    ...
    try:
        ...
        # Set up headers with User-Agent to identify Sniparr
        headers = {
            "X-Api-Key": api_key,
...
def tag_processed_movie(api_url: str, api_key: str, api_timeout: int, movie_id: int, tag_label: str = "sniparr-missing") -> bool:
    """
