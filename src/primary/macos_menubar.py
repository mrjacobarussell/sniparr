"""
macOS menu bar (status bar) icon for Sniparr.
Provides Open Sniparr, Open at Login, and Quit from the menu bar.
...
logger = logging.getLogger("Sniparr")
...
def run_menubar(port=DEFAULT_PORT):
    ...
    menu_items = [
        rumps.MenuItem("Open Sniparr", callback=open_sniparr_cb),
