...
@indexer_snipe_bp.route('/api/indexer-snipe/history', methods=['GET'])
def api_ih_history():
    ...
    try:
        ...
        result = db.get_indexer_snipe_history(
...
@indexer_snipe_bp.route('/api/indexer-snipe/history', methods=['DELETE'])
def api_ih_history_clear():
    ...
    try:
        ...
        with db.get_connection() as conn:
            conn.execute('DELETE FROM indexer_snipe_history')
            conn.execute('DELETE FROM indexer_snipe_stats')
            conn.commit()
