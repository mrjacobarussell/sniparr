#!/usr/bin/env python3
"""
Notification API Routes for Sniparr
...
PROVIDER_META = {
    "discord": {
        ...
        "fields": [
            ...
            {"key": "username", "label": "Bot Username", "type": "text", "required": False,
             "placeholder": "Sniparr", "help": "Display name for the bot (optional)"},
    ...
    "slack": {
        ...
        "fields": [
            ...
            {"key": "username", "label": "Bot Username", "type": "text", "required": False,
             "placeholder": "Sniparr", "help": "Display name (optional)"},
    ...
    "email": {
        ...
        "fields": [
            ...
            {"key": "from_address", "label": "From Address", "type": "text", "required": False,
             "placeholder": "sniparr@example.com", "help": "Sender address (defaults to username)"},
