...
history_locks = {
    ...
    "movie_snipe": threading.Lock(),
    "tv_snipe": threading.Lock()
}
...
def get_history(app_type, search_query=None, page=1, page_size=20, instance_name=None):
    ...
    - instance_name: str - Optional instance name to filter (e.g. instance_id as string for movie_snipe/tv_snipe)
