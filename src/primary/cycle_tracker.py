...
def get_cycle_status(app_type: Optional[str] = None) -> Dict[str, Any]:
    ...
    with _lock:
        try:
            ...
            # List of apps that support multiple instances (movie_snipe, tv_snipe use get_configured_instances)
            arr_apps = ["sonarr", "radarr", "lidarr", "readarr", "whisparr", "eros", "sportarr", "movie_snipe", "tv_snipe"]
