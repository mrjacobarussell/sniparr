#!/usr/bin/env python3
"""
Windows Startup Helper for Sniparr
...
def windows_startup_check():
    ...
    try:
        ...
        try:
            ...
            alt_config = os.path.join(os.path.expanduser("~"), "Documents", "Sniparr")
            os.makedirs(alt_config, exist_ok=True)
            os.environ["SNIPARR_CONFIG_DIR"] = alt_config
            ...
            try:
                ...
                os.environ["SNIPARR_CONFIG_DIR"] = temp_dir
