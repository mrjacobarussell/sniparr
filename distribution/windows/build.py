#!/usr/bin/env python3
"""
Sniparr Windows Build Script
This script builds the Windows executable and installer for Sniparr.
"""
...
def build_exe():
    ...
    print("Building Sniparr Windows executable...")
    ...
    run_command([sys.executable, "-m", "pip", "install", "pyyaml==6.0.1"])
    
    # Build using the spec file
    spec_file = SCRIPT_DIR / "sniparr.spec"
    ...
    # Check if Sniparr.exe was created
    exe_path = ROOT_DIR / "dist" / "Sniparr" / "Sniparr.exe"
...
def build_installer():
    ...
    print("Building Sniparr Windows installer...")
    ...
    dist_dir = ROOT_DIR / "dist" / "Sniparr"
    ...
    installer_script = SCRIPT_DIR / "installer" / "sniparr_installer.iss"
    target_script = ROOT_DIR / "sniparr_installer.iss"
    ...
    installer_path = ROOT_DIR / "installer" / "Sniparr_Setup.exe"
...
def main():
    """Main entry point"""
    parser = argparse.ArgumentParser(description="Build Sniparr for Windows")
