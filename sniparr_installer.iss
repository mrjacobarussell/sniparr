...
; Install the service
Filename: "{app}\{#MyAppExeName}"; Parameters: "--install-service"; Description: "Install Sniparr as a Windows Service"; Tasks: installservice; Flags: runhidden
...
; Start the service
Filename: "{sys}\net.exe"; Parameters: "start Sniparr"; Flags: runhidden; Tasks: installservice
; Launch Sniparr
Filename: "http://localhost:9705"; Description: "Open Sniparr Web Interface"; Flags: postinstall shellexec nowait
; Launch Sniparr
Filename: "{app}\{#MyAppExeName}"; Description: "Run Sniparr Application"; Flags: nowait postinstall skipifsilent; Check: not IsTaskSelected('installservice')

[UninstallRun]
; Stop the service first
Filename: "{sys}\net.exe"; Parameters: "stop Sniparr"; Flags: runhidden
