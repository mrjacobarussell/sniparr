...
routes = [
    ...
    ("/api/tv-snipe/indexers", ["indexers"]),
    ("/api/tv-snipe/indexers/presets", ["presets"]),
    ("/api/tv-snipe/clients", ["clients"]),
    ("/api/tv-snipe/custom-formats", ["custom_formats"]),
    ("/api/tv-snipe/queue", ["queue"]),
    ("/api/tv-snipe/history", ["history"]),
    ("/api/tv-snipe/blocklist", ["items"]),
]
